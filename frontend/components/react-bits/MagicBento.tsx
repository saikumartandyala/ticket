...
const DEFAULT_CARD_DATA: BentoCard[] = [
  { color: '#0d1117', title: 'Verified Sellers', description: 'Every seller logs in via phone OTP verification', label: 'Trust' },
  { color: '#0d1117', title: 'Anti-Scalping', description: 'Prices capped between 30-90% of face value', label: 'Fairness' },
  { color: '#0d1117', title: 'Instant Alerts', description: 'SMS + push the second a matching ticket appears', label: 'Speed' },
  { color: '#0d1117', title: 'Zero Fees', description: 'Completely free to list and search. Always.', label: 'Free' },
  { color: '#0d1117', title: 'Real Reviews', description: 'Ratings from real, completed transfers only', label: 'Honesty' },
  { color: '#0d1117', title: 'Direct Connect', description: 'Chat and reveal contact only when you choose to', label: 'Privacy' },
];
    ...
    <>
      ...
      <BentoCardGrid gridRef={gridRef}>
        {cardData.map((card, index) => {
          ...
          const cardStyle = {
            backgroundColor: card.color ?? '#0d1117',
